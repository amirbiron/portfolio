...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    fullDescription:
      "סוכן AI אישי שמנהל בשבילך שיחות מכירה והתעניינות בוואטסאפ ובטלגרם, כשאתה לא זמין לענות בעצמך — מבוסס על בסיס ידע שאתה מכניס ועל הטון שלך. Listener נפרד לכל ערוץ נכנס לאותו backend, השיחות מופרדות לפי ערוץ.",
    tech: [
      "FastAPI",
      "MongoDB",
      "Node.js",
  ...
  },
  {
    ...
    fullDescription:
      "מערכת SaaS שמרכזת לבעל העסק מקום אחד לכל הפניות הנכנסות — מהמייל, מהוואטסאפ, ממסנג'ר ומהאינסטגרם — מסווגת אוטומטית כל הודעה, ומכינה טיוטת תשובה מתאימה כדי שבעל העסק רק יאשר וישלח. כוללת התראות טלגרם בזמן אמת על לידים חמים.",
    tech: [
      "FastAPI",
  ...
  },
  {
    ...
    fullDescription:
      "מערכת SaaS שיוצרת פוסטים שיווקיים בעברית עבור בעלי עסקים, על בסיס פרופיל מותאם והדוגמאות שהלקוח סיפק — כדי שכל פוסט יישמע 'ממש כמוהם' ולא כמו AI גנרי.",
    tech: [
      "FastAPI",
      "MongoDB",
  ...
  },
  {
    ...
    fullDescription:
      "מערכת SaaS בעברית שמייצרת הצעות מחיר מקצועיות ב-PDF עבור עסקי שירות תוך 60 שניות — עם AI שמנסח את הטקסט, מילוי חכם מתיאור חופשי (Quick AI), חתימה דיגיטלית בעמוד הציבורי ומעקב על מתי הלקוח פתח את ההצעה.",
    tech: [
      "FastAPI",
      "Python 3.11",
      "MongoDB (Motor async)",
