...
**קבצים שהשתנו:**
- `client/src/pages/Home.tsx` — (שונה) הוספת Node.js לקטגוריית Backend בסקשן Skills

**פירוט:**
נוסף "Node.js" כפריט ראשון ברשימת הכישורים של קטגוריית Backend (לפני Flask, FastAPI וכו').
