...
**קבצים שהשתנו:**
- `server/index.ts` — (שונה) נוספו שני סעיפים ל-`SYSTEM_PROMPT` בנקודת הקצה `/api/ask-ai`

**פירוט:**
ל-System Prompt של סוכן ה-AI שעונה על שאלות לגבי CodeKeeper נוספו שני סעיפים בסוף רשימת הכללים, מיד לפני השורה "מסמך תיעוד הפרויקט:". שאר הפרומפט לא שונה.
...
## צירוף אתר התיעוד
* אם יש משתמש שנראה באמת מתעניין, ושואל מס' שאלות (~3) תוכל לצרף לו קישור לאתר התיעוד שלנו (זהו תיעוד יוצא דופן ומקיף במיוחד על CodeKeeper): https://amirbiron.github.io/CodeBot/
